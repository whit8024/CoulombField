...
void initGlut(int argc, char* argv[])
{
    ...
    glutCreateWindow("VibroTactile Research");
...
******************************************************************************/
void initGraphics(const hduVector3Dd &LLB, const hduVector3Dd &TRF, int& width, int&height)
{
...
void drawHapticsString(char* context, const hduVector3Dd pos, const float size=0.1, 
...
{
	if (forceVector.magnitude()<0.0000001) return;
    glDisable(GL_LIGHTING);
